 ...
 */
    ...
    public Node remove(int data) {
        ...
        // 삽입 위치 탐색
        // 빈 리스트가 아니고, 삽입할 데이터가 현재노드의 데이터와 다를 동안 반복
        // 들어갈 위치 찾기 반복문
        while (current != null && data != current.getData()) {
            // 현재 노드를 이전노드에 백업
            prev = current;
        ...
        if(prev == null && current != null) {
          ...
          Node secondNode =  header.getFirstNode().getNextNode(); // == current.getNextNode();
